...
function buildReport(rows, errs, exitRows = [], optIdeas = { calls: [], puts: [] }) {
  ...
  const __out = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
    ...
    + 'select{padding:8px 12px;border:1.5px solid var(--accent);border-radius:9px;background:var(--card);color:var(--fg);font-size:13px;font-weight:600;cursor:pointer}select:focus{outline:none;box-shadow:0 0 0 3px rgba(37,99,235,.25)}select:hover{filter:brightness(1.06)}'
    ...
    + '@media(max-width:680px){.cards thead{display:none}.cards,.cards tbody,.cards tr,.cards td{display:block}.cards tr{border:1px solid var(--line);border-radius:12px;margin:10px 0;padding:2px 14px;background:var(--card)}.cards td{display:flex;justify-content:space-between;align-items:baseline;gap:14px;text-align:right;border:none;border-bottom:1px solid var(--line);padding:9px 0;font-weight:600;font-size:13px;color:var(--fg)}.cards tr td:last-child{border-bottom:none}.cards td::before{content:attr(data-label);color:var(--muted);font-weight:500;text-align:left;white-space:nowrap;flex:none;font-size:10.5px;text-transform:uppercase;letter-spacing:.4px;align-self:center}.cards td:first-child{position:static;box-shadow:none}.cards td>div{margin-left:auto;text-align:right}.cards td.basis{display:block;text-align:left}.cards td.basis::before{display:none}.cards td[data-label="Holding"] b{font-size:15.5px;letter-spacing:.2px}.cards td[data-label="Gain/loss"]{font-size:14.5px;font-weight:700}.cards td[data-label="Signal"] .pill,.cards td[data-label="Action"] .pill{font-size:12.5px}.cards td[data-label="Take-profit"],.cards td[data-label="Take-profit"] span{color:var(--up)!important}.cards td[data-label="Take-profit"]{font-size:13px!important;font-weight:700}.cards td[data-label="Safety price"]{color:var(--warn)!important;font-weight:700}.cards td[data-label="Volume 30d"]{color:var(--poc)!important;font-size:12.5px!important}}'
    + '</style></head><body>'
