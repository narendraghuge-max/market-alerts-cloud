...
function buildReport(rows, errs, exitRows = [], optIdeas = { calls: [], puts: [] }) {
  ...
  const __out = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
    ...
    + '.mvtbl{width:100%;border-collapse:collapse;font-size:13px;margin-top:7px}.mvtbl th{text-align:left;color:var(--muted);font-weight:500;font-size:9.5px;text-transform:uppercase;letter-spacing:.3px;padding:4px 5px;border-bottom:1px solid var(--line)}.mvtbl td{padding:8px 5px;border-bottom:1px solid var(--line);vertical-align:middle}.mvtbl tr:last-child td{border-bottom:none}.mvb{display:inline-block;color:#fff;font-size:9.5px;font-weight:700;padding:2px 6px;border-radius:5px;letter-spacing:.3px;white-space:nowrap}'
