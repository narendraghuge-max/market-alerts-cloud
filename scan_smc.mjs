...
function buildReport(rows, errs, exitRows = [], optIdeas = { calls: [], puts: [] }) {
  ...
  const __out = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
    ...
    + '<link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Space+Grotesk:wght@500;600;700&display=swap" rel="stylesheet">'
    + '<style>'
    ...
    + 'body{margin:0;background:var(--bg);color:var(--fg);font-family:Inter,-apple-system,Segoe UI,Roboto,Arial,sans-serif;padding:20px;border-top:3px solid var(--accent);-webkit-font-smoothing:antialiased}'
    + "h1,.sec>summary,.logo{font-family:'Space Grotesk',Inter,sans-serif}"
