...
function buildReport(rows, errs, exitRows = [], optIdeas = { calls: [], puts: [] }) {
  ...
  const __out = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
    ...
    + '@media(max-width:680px){.cards thead{display:none}.cards,.cards tbody{display:block}.cards tr{display:grid;grid-template-columns:1fr 1fr;column-gap:14px;border:1px solid var(--line);border-radius:12px;margin:10px 0;padding:9px 14px;background:var(--card)}.cards td{display:block;border:none;padding:5px 0;text-align:left;font-weight:600;font-size:13px;color:var(--fg);min-width:0;overflow-wrap:anywhere}.cards td::before{content:attr(data-label);display:block;color:var(--muted);font-weight:500;font-size:10px;text-transform:uppercase;letter-spacing:.4px;margin-bottom:1px}.cards td:first-child{position:static;box-shadow:none}.cards td>div{text-align:left}.cards td[data-label="Basis"],.cards td[data-label="What to do"],.cards td[data-label="Take-profit"]{grid-column:1/-1}.cards td.basis{text-align:left}.cards td.basis::before{display:none}.cards td[data-label="Holding"] b{font-size:15px}.cards td[data-label="Gain/loss"]{font-size:14px;font-weight:700}.cards td[data-label="Signal"] .pill,.cards td[data-label="Action"] .pill{font-size:12.5px}.cards td[data-label="Take-profit"],.cards td[data-label="Take-profit"] span{color:var(--up)!important;font-weight:700}.cards td[data-label="Safety price"]{color:var(--warn)!important;font-weight:700}.cards td[data-label="Volume 30d"]{color:var(--poc)!important}}'
    + '</style></head><body>'
